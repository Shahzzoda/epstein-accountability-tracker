...
function TwitterIcon() {
    return (
        <svg className="h-4 w-4 text-slate-400 hover:text-[#1DA1F2]" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
