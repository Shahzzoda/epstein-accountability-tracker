        ...
        <section className="section-card rounded-xl p-6">
          ...
          <div className="mt-4 overflow-x-auto">
            <table className="min-w-full text-left text-sm text-slate-700">
              ...
              <tbody>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Supportive recorded vote</td><td className="py-2 pr-4">+2.0</td><td className="py-2"><code>epstein_transparency_act.signed == yes</code></td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Sponsored disclosure bill</td><td className="py-2 pr-4">+1.5</td><td className="py-2"><code>epstein_transparency_act.sponsored</code></td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Signed discharge petition</td><td className="py-2 pr-4">+1.0</td><td className="py-2"><code>epstein_transparency_act.discharge_petition.signed</code></td></tr>
                ...
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Active Public Advocacy</td><td className="py-2 pr-4">+1.0</td><td className="py-2"><code>public_pressure_score &gt;= 3.0</code></td></tr>
                <tr className="border-b border-[var(--border)]"><td className="py-2 pr-4">Recorded non-supportive vote</td><td className="py-2 pr-4">-1.0</td><td className="py-2"><code>epstein_transparency_act.signed == no</code></td></tr>
              </tbody>
            </table>
          </div>
          <div className="mt-4 rounded-md bg-slate-50 p-4 text-sm text-slate-700">
            ...
            <ul className="mt-1 list-inside list-disc space-y-1">
              ...
              <li><strong>Score Cap:</strong> 3.0 (Limited/Minimal) unless the lawmaker has <strong>Active Advocacy</strong> or has <strong>Sponsored/Cosponsored</strong> legislation.</li>
...
+ cosponsor 1.0
= 3.0 (Minimal)
* Cap is lifted by cosponsorship.
* Status maps to Orange (Minimal)`}
              </pre>
            </div>
          </div>
        </section>
